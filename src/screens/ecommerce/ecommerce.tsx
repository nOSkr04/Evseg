...
const EcommerceScreen = memo(() => {
  const data = [
    { _id: "1", img: "https://cdn.greensoft.mn/uploads/site/1176/photos/module_product/20230912163343_cc9364c45775890bda9398debfb54db7.JPG", imgs: ["https://cdn.greensoft.mn/uploads/site/1176/photos/module_product/20230912163343_cc9364c45775890bda9398debfb54db7.JPG", "https://cdn.greensoft.mn/uploads/site/1176/photos/module_product/20230912163415_f2ea41808e2017e64e025e65e7fce195.JPG", "https://cdn.greensoft.mn/uploads/site/1176/photos/module_product/20230912163447_6a80ba0e4daa7d1b2a8afd7711ffd3cf.JPG"], name: "Пальто", price: 1060000, },
  ...
  return (
    <>
      <AppBar title="Онлайн дэлгүүр" />
      <FlatList data={data} renderItem={renderItem} numColumns={2} keyExtractor={item => item._id} style={styles.container} showsVerticalScrollIndicator={false} />
    </>
  )
})
