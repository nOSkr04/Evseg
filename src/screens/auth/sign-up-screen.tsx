  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.root}>
      ...
      <ScrollView style={styles.container}>
        <Image source={require("../../assets/img/gradient.png")} style={styles.imgBg} transition={500} />
        <View  style={styles.blurContainer}>
          <Image source={require("../../assets/img/nobglogo.png")} style={styles.logo} transition={1000} />
        </View>
        <View style={styles.contentContainer}>
          ...
          {errors.root?.type === 500 && <MonMedium style={styles.errorText}>Бүртгэлтэй хэрэглэгч байна</MonMedium>}
...
const styles = StyleSheet.create({
  ...
  blurContainer: {
    position      : "absolute", alignItems    : "center", justifyContent: "center", right         : 0, left          : 0,
    height        : Dimensions.get("window").height / 2.5,
  },
  contentContainer: {
    backgroundColor     : DefaultColors.white,
